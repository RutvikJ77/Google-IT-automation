...
if __name__ == "__main__":
    usr = os.getenv('usr')
    des_dir = '/home/{}/supplier-data/descriptions/'.format(usr)  # The directory which contains all the files with data in it.
    ...
    generate_report('/tmp/processed.pdf', title, pdf_body('pdf',des_dir))  # calling the report function from custom module
    ...
    msg = generate_email("automation@example.com", "{}@example.com".format(usr),
